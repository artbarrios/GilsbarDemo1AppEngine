...
namespace GilsbarDemo1AppEngine.Web_Data
{
    class ManagersWebData
    {
        ...
        public static List<Manager> GetManagers()
        {
            ...
            string webApiPath = "api/ManagersData";
            string results = "";
            try
            {
                ...
                return JsonConvert.DeserializeObject<List<Manager>>(results);
            }
            catch (Exception e)
            {
                string message = AppCommon.AppendInnerExceptionMessages("GetManagers: " + e.Message, e);
