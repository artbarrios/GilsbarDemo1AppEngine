        ...
        public static void GenerateReport(Report report)
        {
            ...
            switch (report.Name.ToUpper())
            {
                case "SAMPLEREPORT":
                    ...
                    break; // SAMPLEREPORT
                case "BUILDINGSINDEXPRINTERFRIENDLY":
                    Reports.BuildingsIndexPrinterFriendlyReport.Generate(report, fileSaveDirectory, app);
                    break;
                case "DEPARTMENTSINDEXPRINTERFRIENDLY":
                    Reports.DepartmentsIndexPrinterFriendlyReport.Generate(report, fileSaveDirectory, app);
                    break;
                case "JOBTASKSINDEXPRINTERFRIENDLY":
                    Reports.JobTasksIndexPrinterFriendlyReport.Generate(report, fileSaveDirectory, app);
                    break;
                case "MANAGERSINDEXPRINTERFRIENDLY":
                    Reports.ManagersIndexPrinterFriendlyReport.Generate(report, fileSaveDirectory, app);
                    break;
                case "PERSONSINDEXPRINTERFRIENDLY":
                    Reports.PersonsIndexPrinterFriendlyReport.Generate(report, fileSaveDirectory, app);
                    break;
