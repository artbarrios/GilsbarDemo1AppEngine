...
{
    class DepartmentsIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("DepartmentsIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "Departments";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<Department> departmentsWebData = new List<Department>();
            departmentsWebData = Web_Data.DepartmentsWebData.GetDepartments();
            ...
            table.Rows[table.Rows.Count].Cells[2].Range.Text = "Building";
            ...
            // add table data rows
            foreach (Department department in departmentsWebData)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = department.Name.ToString();
                table.Rows[table.Rows.Count].Cells[2].Range.Text = department.BuildingId.ToString();
