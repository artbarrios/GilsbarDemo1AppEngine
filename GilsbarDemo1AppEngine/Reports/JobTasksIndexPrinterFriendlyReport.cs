...
{
    class JobTasksIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("JobTasksIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<JobTask> jobTasksWebData = new List<JobTask>();
            jobTasksWebData = Web_Data.JobTasksWebData.GetJobTasks();
            ...
            document.Tables.Add(paragraph.Range, 1, 3); // 1 X count of properties
            ...
            table.Rows[table.Rows.Count].Cells[2].Range.Text = "Description";
            table.Rows[table.Rows.Count].Cells[3].Range.Text = "Image Filename";
            ...
            // add table data rows
            foreach (JobTask jobTask in jobTasksWebData)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = jobTask.Name.ToString();
                table.Rows[table.Rows.Count].Cells[2].Range.Text = jobTask.Description.ToString();
                table.Rows[table.Rows.Count].Cells[3].Range.Text = jobTask.ImageFilename.ToString();
